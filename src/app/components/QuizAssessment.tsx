...
const quizQuestions: Question[] = [
  ...
  },
  {
    ...
    correctAnswer: "B",
    explanation: "Vaccination provides active artificial immunity by introducing antigens to stimulate immune response.",
  },
  {
    id: 4,
    ...
    correctAnswer: "B",
    explanation: "Pathogens are microorganisms that cause disease, including bacteria, viruses, and fungi.",
  },
  {
    id: 5,
    ...
    correctAnswer: "B",
    explanation: "Memory cells remember past infections, allowing the immune system to respond more quickly if the same pathogen returns.",
  },
  {
    id: 6,
    ...
    correctAnswer: "C",
    explanation: "T-lymphocytes, especially cytotoxic T cells, are responsible for directly killing infected cells.",
  },
  {
    id: 7,
    ...
    correctAnswer: "A",
    explanation: "An antigen is any substance that causes the immune system to produce antibodies against it.",
  },
  {
    id: 8,
    ...
    correctAnswer: "B",
    explanation: "Bone marrow is the primary site of white blood cell production in the body.",
  },
  {
    id: 9,
    ...
    correctAnswer: "C",
    explanation: "Babies receive passive natural immunity through antibodies in breast milk from their mothers.",
  },
  {
    id: 10,
    ...
    correctAnswer: "C",
    explanation: "Antibodies are part of the adaptive immune response, not a physical barrier. Skin, mucus, and stomach acid are physical/chemical barriers.",
  },
];
...
export function QuizAssessment() {
  ...
  const handleSubmit = () => {
    ...
    if (selectedAnswer === currentQ.correctAnswer && !answeredQuestions.includes(currentQuestion)) {
      setScore(score + 1);
            ...
            <div className="text-center">
              ...
              {percentage >= 80 && (
                <div className="bg-green-50 border-2 border-green-600 rounded-lg p-6 mb-4">
                  ...
                  <p className="text-green-600">You have a strong understanding of the immune system.</p>
                </div>
              )}
              {percentage >= 60 && percentage < 80 && (
                <div className="bg-blue-50 border-2 border-blue-600 rounded-lg p-6 mb-4">
                  ...
                  <p className="text-blue-600">You have a good grasp of the concepts. Review the material for even better results.</p>
                </div>
              )}
              {percentage < 60 && (
                <div className="bg-orange-50 border-2 border-orange-600 rounded-lg p-6 mb-4">
                  <h3 className="text-2xl font-bold text-orange-700 mb-2">Keep Learning!</h3>
                  <p className="text-orange-600">Review the lecture notes and try again. You're making progress!</p>
                </div>
              )}
              <Button onClick={handleRestart} className="bg-blue-600 hover:bg-blue-700 text-white px-8">
                Retake Quiz
              </Button>
            </div>
          </CardContent>
        ...
        <CardHeader>
          ...
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
              ...
              <span className="text-blue-600 font-medium">Score: {score}/{quizQuestions.length}</span>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className={`font-semibold mb-1 ${
                    selectedAnswer === currentQ.correctAnswer ? "text-green-900" : "text-red-900"
                  }`}>
